...
The Typography tab offers 10 curated pairings and six independent roles: display headings, section/card headings, paragraphs, eyebrows, buttons/navigation, and captions/small print. All roles have the same 20 locally hosted font families, including Māori macrons. **Export** downloads colour, typography, mode and saved layout choices; **Reset colours & type** restores the default Tidal Bloom / Coastal editorial combination without resetting layouts.
