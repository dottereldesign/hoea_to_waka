...
The public site has 17 purpose-based component categories with 25 curated layouts each, including 100 new hero, header, feature and contact layouts, plus preserved earlier designs. It also includes 10 coordinated colour palettes, and 20 font families with 20 suggested typography pairings. Use the bottom-left **Colours & type** button for site-wide foundations, and **Design studio** for layouts. See [DESIGN-STUDIO.md](DESIGN-STUDIO.md) for the layout library and [theme research](design/THEME-RESEARCH.md) for palette and typography decisions.
...
The Typography tab offers 20 curated pairings and six independent roles: display headings, section/card headings, paragraphs, eyebrows, buttons/navigation, and captions/small print. Heading roles offer 12 serif families; body, eyebrow, navigation and caption roles offer 8 sans-serif families. All are locally hosted with macron coverage. **Export** downloads colour, typography, mode and saved layout choices; **Reset colours & type** restores the default Draft 1 palette / Instrument Serif and Instrument Sans combination without resetting layouts.
...
Typography now offers 12 new serif heading families and 8 new sans-serif body families, with 20 visible pairing previews. All previous picker families have been replaced. Existing layout and palette selections are preserved; retired font IDs migrate to Instrument Serif / Instrument Sans. See [font research](design/FONT-RESEARCH-2026.md). Run `node scripts/draft.cjs` and `node scripts/fonts.cjs` for baseline and typography checks.
